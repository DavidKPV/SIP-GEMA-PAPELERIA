			...
			<div class="container">
				<div class="main row">
					...
					<center>
						...
						<h6>BIENVENIDO ADMINISTRADOR <?php echo "<strong>".$nombre_usuario."</strong>"; ?></h6>
						<br>
					<center>
					</div>
...
<!-- SI SE ACTIVA EL BUSCADOR ********************************************************************************** -->
	...
	?>
				<table class="table table-striped">
				  <thead>
				  	<tr>
						<th colspan="4"><h6 class="wordinicio"><center><strong>PRODUCTOS EN EXISTENCIA</strong></center><h6></td>
					</tr> 
				    <tr>
				      <th scope="col">ID</th>
...
<!-- BARRA DERECHA DEL BUSCADOR ********************************************************************************** -->
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-2" id="caja_derecha">
				<center>
					<form method="POST">
						<br>
						...
						<br>
						<button id="boton" type="submit" name="estadis">Ver Estadísticas</button>
						<br>
					</form>
						...
						<ul class="nav" id="nav-principal">
							<li><a href="">Opciones de Usuario</a>
								<ul>
									...
									<li><a href="editar.php">Editar Producto</a></li>
